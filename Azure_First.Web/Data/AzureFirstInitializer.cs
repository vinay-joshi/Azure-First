...
{
    public class AzureFirstInitializer : DropCreateDatabaseIfModelChanges<AzureFirstContext>
    {
        public AzureFirstInitializer()
        {

        }

        protected override void Seed(AzureFirstContext context)
        {
        ...
        private void AddData(AzureFirstContext context)
        {
